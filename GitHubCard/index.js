...
followersArray.forEach(follower => {
  ...
  .then(res => {
    ...
    gitCards.appendChild(createCards(res.data));
...
axios.get(`https://api.github.com/users/tommykindle`)
  .then(res => {
      console.log(res);

      const makeCard = createCards(res.data)
      gitCards.appendChild(makeCard)
  })
